...
-- para se continuado no desafio: termine de implementar a tabela e crie a conexão com as tabelas necessárias
...
create table orders(
    ...
    constraint fk_orders_client foreign key(idOrderClient) references clients(idClient)
		on update cascade
        -- on delete set null (isso deleta os pedidos)
);
...
select concat(Fname,' ',Lname) as Client, idOrder as Request, orderStatus as Status from clients c, orders o where c.idClient = idPOorder;
